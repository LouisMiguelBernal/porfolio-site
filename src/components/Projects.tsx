  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'pointer',
        flexShrink: 0,
        // Active = wide, inactive = narrow peeking strip
    ...
    >
      ...
      {/* _1 screenshot — crossfades in when active + hovered */}
      <div style={{
        position: 'absolute', inset: 0,
      ...
      {/* Collapsed label — only on narrow/inactive cards */}
      {!isActive && (
        <div style={{
      ...
      {/* Expanded content — only on active card */}
      {isActive && (
        <div style={{
          ...
          <div style={{
            ...
            <a
              ...
              style={{
                ...
                letterSpacing: '0.03em', transition: 'opacity 0.2s', flexShrink: 0,
              }}
    ...
    <section id="projects" style={{ padding: '120px 32px', position: 'relative' }}>
        ...
        <div ref={headRef} className="section-animate" style={{ marginBottom: '56px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '24px' }}>
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', color: 'var(--text-muted)', maxWidth: '460px', lineHeight: 1.65 }}>
              Click a project to expand it, then hover to reveal details and screenshots.
            </p>
          </div>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .proj-card-active { display: flex !important; width: 90vw !important; }
        }
      `}</style>
    </section>
  )
